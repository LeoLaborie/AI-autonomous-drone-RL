...
public class DefenderFlight : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        transform.localPosition = target.localPosition + new Vector3(Random.Range(-20, 20), Random.Range(20, 40), Random.Range(-20, 20));
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(new Vector3(Random.Range(-200,200), Random.Range(-200,200), Random.Range(-200,200))); // 3
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        AddReward(distanceRewardTarget);
        ...
        // Même formule, max à 10m, décroît au carré
        float distanceRewardAlly = 1f - Mathf.Pow(minAllyDistance - 10f, 2) / 400f;
        AddReward(distanceRewardAlly);
